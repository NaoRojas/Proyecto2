...
public class VentanaConsultarMaterial extends VentanaConsultar {

    public VentanaConsultarMaterial(String titulo, Control control) throws HeadlessException {
    ...
    public void mostrarInformacion() {
        ...
        areaTexto1.setText(this.gestorPrincipal.mostrarInformacionElementoEspecifico(codigo, 1));
    ...
    public void ajustarPanelCentro(Container c) {
        ...
        panelCentro.add(areaTexto1 = new JTextArea(this.gestorPrincipal.mostrarModeloMaterial()));
    ...
    public void reconsultarInformacion() {
        ...
        areaTexto1.setText(this.gestorPrincipal.mostrarModeloMaterial());
