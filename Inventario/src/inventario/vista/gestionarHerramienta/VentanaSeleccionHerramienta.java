...
public class VentanaSeleccionHerramienta extends JFrame implements Observer {
    ...
    public VentanaSeleccionHerramienta(String titulo, ControlHerramienta control, int codigo) throws HeadlessException {
        super(titulo);
