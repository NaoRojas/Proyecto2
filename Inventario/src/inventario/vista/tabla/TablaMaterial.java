...
public class TablaMaterial extends AbstractTableModel {

    private final Control gestorPrincipal;
    
    public TablaMaterial(Control control) {
    ...
    public int getRowCount() {
        return (gestorPrincipal.obtenerCantidadMaterial());
    }
    ...
    public Object getValueAt(int indiceFila, int indiceColumna) {
       String[] d = gestorPrincipal.getMaterial(indiceFila).obtenerArregloDatos();
